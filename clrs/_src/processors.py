...
class FALR10(Processor):
  ...
  def __call__(  # pytype: disable=signature-mismatch  # numpy-scalars
    ...
    ln_msg = hk.LayerNorm(axis=-1, create_scale=True, create_offset=True)
    ...
    '''
    msg_n_1 = ln_msg(node_fts_mem)
    msg_h_1 = ln_msg(hidden_mem)
    msg_e_1 = ln_msg(edge_fts_mem)
    msg_g_1 = ln_msg(graph_fts_mem)
    '''
